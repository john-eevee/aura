defmodule AuraWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AuraWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AuraWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AuraWeb.Gettext, "errors", msg, opts)
    end
  end
